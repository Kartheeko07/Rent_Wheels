...
echo "<div class='row'>";
  ...
  echo '<div  id="divtag" value ="'.$price.'" class="col-sm-2"><p id="agg_price" >$'.$price.'</p></div>';
		echo "</div>";
		echo '<div class="row"><div class="col-sm-12"><button  id="checkout" type="button"><a href= "car_initialize.php?number_plate='.$row['number_plate'].'&price='.$row['price'].'&no_of_days='.'">Check Out</button></div></div>';
