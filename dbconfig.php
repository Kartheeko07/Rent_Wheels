...
<?php
try{
$connection = mysqli_connect("localhost","root", "","car_rental") ; // Establishing connection with server..
...
mysqli_query($connection,"Insert into users_table  (user_name,user_email,user_password,licence_no,address) values('$username','$email','$hpassword','$licence','$address')"); // Insert query
